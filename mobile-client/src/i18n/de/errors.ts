...
const errors: Catalog = {
    ...
    'err.bad_message': 'Diese Nachricht konnte nicht gelesen werden.',
    'err.bad_bot_count': 'Wähle zwischen 0 und {max} Robotern.',
    'err.invalid_game_state': 'Das Spiel ist in einem ungültigen Zustand.',
    'err.duplicate_double_rent': 'Dieselbe Doppelte-Miete-Karte kann nicht zweimal verwendet werden.',
