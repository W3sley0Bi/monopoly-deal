...
const tutorial: Catalog = {
    ...
    'lesson.property.body': 'Solo le proprietà fanno vincere. Mettine una sul tappeto e inizia una serie di colore — sul telefono basta lasciarla ovunque sul tuo tabellone, trova da sola la pila giusta.',
    'lesson.property.task': 'Gioca una carta proprietà in una serie.',
    'lesson.wildcard.title': 'Una jolly',
    'lesson.wildcard.body': 'Una jolly vale come uno dei suoi due colori. Il colore con cui sta giocando si prende la carta; l’altro tiene una striscia in fondo. Toccala per girarla, poi trascinala sulla serie di quel colore. Metti questa con il blu che hai già.',
    'lesson.wildcard.task': 'Gioca la jolly come blu.',
    'lesson.wildcard_any.title': 'La jolly di ogni colore',
    'lesson.wildcard_any.body': 'L altra jolly non ha un colore suo: entra in qualsiasi serie. In banca non vale nulla, e da sola non fa una serie. Siccome ogni colore andrebbe bene, prima di giocarla bisogna dirle quale intendi.',
    'lesson.wildcard_any.task': 'Gioca la jolly nella tua serie rossa.',
    ...
    'lesson.end_turn.body': 'Hai tre giocate per turno e puoi chiudere prima. Le giocate non usate si perdono. Se alla fine hai più di sette carte, quelle in eccesso vengono scartate per te a caso — non devi scegliere.',
