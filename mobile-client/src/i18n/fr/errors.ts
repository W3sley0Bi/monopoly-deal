...
const errors: Catalog = {
    ...
    'err.bad_message': 'Ce message n’a pas pu être lu.',
    'err.bad_bot_count': 'Choisissez entre 0 et {max} robots.',
    'err.invalid_game_state': 'La partie est dans un état invalide.',
    'err.duplicate_double_rent': 'La même carte Loyer double ne peut pas être utilisée deux fois.',
