...
export default function Sheet({ title, subtitle, onClose, children, footer }: Props) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex flex-col justify-end bg-black/60" onClick={onClose}>
            ...
            <div
                className="animate-sheet-up flex max-h-[78vh] min-h-0 flex-col overflow-hidden rounded-t-2xl border border-b-0 border-white/12 bg-[#08281d] shadow-[0_-20px_50px_-20px_rgb(0_0_0/0.9)]"
            ...
            >
                <div className="flex items-center gap-3 border-b border-white/10 bg-black/25 px-4 py-3">
                    ...
                    <div className="min-w-0 flex-1">
                        <h2 className="truncate font-display text-xl tracking-wide text-brass">{title}</h2>
