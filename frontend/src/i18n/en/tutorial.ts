...
const tutorial: Catalog = {
    ...
    'lesson.property.body': 'Properties are the only cards that win. Put one on your mat to start a colour set — on a phone, drop it anywhere on your board and it finds the right stack for you.',
    'lesson.property.task': 'Play a property card into a colour set.',
    'lesson.wildcard.title': 'A wildcard',
    'lesson.wildcard.body': 'A wildcard counts as either of its two colours. The colour it is currently playing as takes the card; the other keeps a strip along the bottom. Tap it to turn it over, then drag it onto that colour’s set. Put this one with the blue you already own.',
    'lesson.wildcard.task': 'Play the wildcard as blue.',
    'lesson.wildcard_any.title': 'The any-colour joker',
    'lesson.wildcard_any.body': 'The other joker has no colour of its own: it joins any set you like. It is worth nothing in the bank, and it cannot make a set on its own. Because every colour would do, it has to be told which one you mean before it can be played.',
    'lesson.wildcard_any.task': 'Play the joker into your red set.',
    ...
    'lesson.end_turn.body': 'You get three plays each turn, and you can end early. Unused plays are lost, so spend them. Holding more than seven cards when you end? The extra ones are discarded for you at random — no need to choose.',
