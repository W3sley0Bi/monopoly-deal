...
const errors: Catalog = {
    ...
    'err.bad_message': 'That message could not be read.',
    'err.bad_bot_count': 'Choose between 0 and {max} robots.',
    'err.invalid_game_state': 'The game is in an invalid state.',
    'err.duplicate_double_rent': 'The same Double The Rent card cannot be used twice.',
