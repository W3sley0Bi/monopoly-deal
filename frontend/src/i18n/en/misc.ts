...
const misc: Catalog = {
    ...
    'call.settings_intro': "Stay face to face while the deal unfolds.",
    'call.back_game': "Back to the table",
    'call.cancel_join': "Cancel joining",
    'call.voice_only': "Join voice only",
    'call.with_camera': "Join with camera",
    'call.permission_hint': "Allow access in your browser to continue.",
    'call.camera_live': "Your camera is visible to the call.",
    'call.camera_private': "Your camera is off. You can still talk.",
    'call.gallery': "Open call gallery",
    'call.layout': "Video layout",
    'call.layout.auto': "Adaptive · recommended",
    'call.layout.seats': "At player seats",
    'call.layout.strip': "Filmstrip",
    'call.layout.corner': "Floating corner",
    'call.layout_hint': "Adaptive uses player seats on large screens and a filmstrip on smaller ones. Seat view also becomes a filmstrip when space is tight.",
    'call.devices': "Camera & microphone",
    'call.microphone': "Microphone",
    'call.camera': "Camera",
    'call.system_default': "System default",
    'call.quality': "Video quality",
    'call.quality.low': "Data saver · 180p",
    'call.quality.balanced': "Balanced · 360p",
    'call.quality.high': "Sharper · 720p",
    'call.device_hint': "Changes apply live. Lower quality helps slower connections.",
    'call.device_permission': "Device names appear after you grant access. Nothing is captured until you join.",
    'call.sound_display': "Sound & self view",
    'call.join_mic': "Start with microphone on",
    'call.hide_self': "Hide my preview · others can still see me",
    'call.mirror': "Mirror my preview only",
    'call.deafen': "Mute call sound · microphone stays unchanged",
    'call.volume': "Call volume",
    'call.connecting': "Connecting…",
    'call.expand_person': "Enlarge {name}’s video",
    ...
    'call.hide_video': "Collapse videos · keep talking",
    'call.at_seats': "Videos are beside the players.",
    'call.self_hidden': "Your preview is hidden.",
    'call.gallery_hint': "Enlarge anyone’s video. Sound controls here affect only what you hear.",
    'call.all_people': "Show everyone",
    'call.hear_person': "Hear {name} again",
    'call.mute_person': "Mute {name} for me",
};
