...
const errors: Catalog = {
    ...
    'err.bad_message': 'Impossibile leggere il messaggio.',
    'err.bad_bot_count': 'Scegli tra 0 e {max} robot.',
    'err.invalid_game_state': 'La partita è in uno stato non valido.',
    'err.duplicate_double_rent': 'La stessa carta Doppio Affitto non può essere usata due volte.',
    ...
    // Transport
    'err.client_outdated': "Quest'app non è aggiornata. Aggiornala per continuare a giocare online.",
    'err.server_outdated': "Il server è più vecchio di quest'app. Chiedi a chi lo ospita di aggiornarlo.",
